...
$source=Join-Path $SourceRoot 'mukorob-pdf-app'
...
Set-ItemProperty -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Uninstall\MukorobPDF' -Name DisplayVersion -Value '0.5.0'
